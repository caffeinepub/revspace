...
export const idlService = IDL.Service({
  ...
  'addCommentReply' : IDL.Func([IDL.Text, IDL.Text, IDL.Text], [IDL.Text], []),
  ...
  'adminGetAllProfilesPublic' : IDL.Func(
      [IDL.Text],
      [IDL.Vec(ProfileWithPrincipal)],
      ['query'],
    ),
  'adminGetAllUsers' : IDL.Func([], [IDL.Vec(UserWithRole)], ['query']),
  'adminPromoteToAdmin' : IDL.Func([IDL.Text], [], []),
  'adminSetUserMeta' : IDL.Func([IDL.Principal, IDL.Text, IDL.Text], [], []),
  ...
  'getRepliesToComment' : IDL.Func([IDL.Text], [IDL.Vec(Comment)], ['query']),
