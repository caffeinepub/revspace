...
// ─── Model Gift Items (giftable by any user to model accounts) ────────────────

export const MODEL_GIFT_ITEMS: ShopItem[] = [
  {
    id: "model-gift-fan-letter",
    name: "Fan Letter",
    emoji: "💌",
    category: "Send to a Model",
    cost: 50,
    rarity: "common",
